...
```{r}
#| label: fig-nyc-map
#| fig-cap: Per capita services contracted out in NYC by health area, 1997-2001
#| echo: false
...
#| fig-cap: Visual display of factor loadings
...
#| fig-cap: comparison of the summated scale vs. factor score
#| echo: false
...
```{r}
#| label: fig-correlogram-moral
#| fig-cap: Correlogram of morality variables from Pew data
#| fig-width: 24
#| fig-height: 14
...
```{r}
#| label: fig-factor-morality
#| fig-cap: Factor analysis of morality data
#| layout-ncol: 3
#| fig-width: 24
#| fig-height: 28
#| echo: false
...
fa.diagram(morality_fa1, main = NULL, l.cex = 5)
fa.diagram(morality_fa2, main = NULL, l.cex = 5)
fa.diagram(morality_fa3, main = NULL, l.cex = 5)
```
