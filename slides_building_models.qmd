...
ggplot(crimes, aes(x=unemploy_rate, y=property_rate))+
  ...
  annotate("label", x=1, coef(model)[1]*0.92, label=paste("y-intercept=", round(coef(model)[1], 2), sep=""), size=15)+
  ...
  annotate("segment", x = 6, xend = 6, 
           ...
           color="red",
           arrow=arrow(length=unit(0.1,"cm"), type = "closed"))+
  annotate("label", x=5.5, y=ypredict[1]*0.92, label="run", size=15)+
  annotate("label", x=6.3, y=mean(ypredict), label="rise", size=15)+
...
ggplot(crimes, aes(x=reorder(state, property_rate, median), y=property_rate))+
  ...
  annotate("label", x=49, y=mean(crimes$property_rate), 
           label="mean of property crime rate", color="red", size=8)+
...
ggplot(crimes, aes(x=unemploy_rate, y=property_rate))+
  ...
  annotate("label", x=4, y=mean(crimes$property_rate), 
...
ggplot(subset(gapminder, year==2007), aes(x=gdpPercap, y=lifeExp))+
  ...
  ylim(30,90)+
  annotate("label", x=10000, y=75, label="Underestimate", size=8)+
  annotate("label", x=2000, y=50, label="Overestimate", size=8)+
  annotate("label", x=45000, y=80, label="Overestimate", size=8)+
...
ggplot(crimes, aes(x=median_age, y=property_rate))+
  ...
  geom_smooth(data=subset(crimes, state!="District of Columbia"),
              method="lm", se=FALSE, color="red", linewidth=3)+
...
plot(-2,-2, xlim=c(0,10), ylim=c(0,10), xaxt="n", yaxt="n", bty="n", xlab="", ylab="")
rect(1,5,4,9, col="skyblue")
text(2.5,7,"percent with\no HS diploma", cex=1.2)
rect(6,5,9,9, col="skyblue")
text(7.5,7,"property crime\nrate", cex=1.2)
arrows(4,7,6,7, length=0.1)
text(5,7.5,"+71.4", cex=1.2)
```
...
#arrows(4,7,6,7)
arrows(5.5,4,6,5, length=0.1)
text(4.5,4.5,"_", cex=1.2)
arrows(4.5,4,4,5, code=3, length=0.1)
text(5.5,4.5,"_", cex=1.2)
arrows(4,7,6,7, length=0.1)
text(5,7.5,"-79.4", cex=1.2)
```
...
ggplot(sex, 
  ...
  geom_point(data=data.frame(female=c(0,1), 
             ...
             color="red", size=5)+
  annotate("label", 0.5, 60, label="best fitting line connects the dots between the two means", size=10)
```
...
ggplot(sex, 
  ...
  geom_point(data=data.frame(female=c(0,1), 
                             sexf=tapply(sex$sexf, sex$female, mean)),
             color="red", size=5)+
  annotate("label", 0.5, 60, label="The slope is equal to the mean difference of -2.17", size=10)
```
