...
* States with a higher percent of the population without a high school diploma hava higher poverty rate, on average.
...
htmlreg(list(model1, model2, model3),
        ...
        caption="Linear models predicting property crime rates across states",
        caption.above=TRUE,
        digits=2,
        star.symbol='&#42;',
...
ggplot(sex, 
  ...
  geom_point(data=data.frame(female=c(0,1), 
                             sexf=tapply(sex$sexf, sex$female, mean)),
             color="red", size=5)+
  annotate("label", 0.5, 60, label="The slope is equal to the mean difference of -5.854", size=10)
```
...
In a model, we can calculate mean differneces while holding constant other variables. 
...
htmlreg(list(model1, model2),
        ...
        custom.coef.names = c("Intercept",
                              ...
                              "age"),
        custom.gof.names = c("R-squared","N"),
        caption="Linear models predicting hourly waages",
        caption.above=TRUE,
        digits=2,
        star.symbol='&#42;',
