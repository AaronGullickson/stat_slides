...
Where $\mu_M$ is the population mean sexual frequency of married individuals and $\mu_D$ is the population mean sexual frequency of never-married individuals.
...
## `r emo::ji("thinking_face")` A p-value of 7.082129e-08? {.smaller}

* What does the value of 7.082129e-08 mean? 
* The number is so small that R is reporting it using scientific notation: $$7.082129 x 10^{-8}$$
* That means we need to move the decimal place over 8 spaces to the left. So the number is really 0.00000007082129. So I would interpret my result as: 

::: {.fragment}

> Assuming that there is no difference in the US population between those who have served in the military and those who have not in support for removing birthright citizenship, there is less than a 0.000007% chance of observing a sample difference in proportion of 13.1% or greater by random chance in a sample of this size. Thus, I **reject** the null hypothesis there there is no difference in support for removing birthright citizenship between those who have served in the military and those who have not. 
